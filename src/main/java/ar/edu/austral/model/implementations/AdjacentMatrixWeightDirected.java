...
public class AdjacentMatrixWeightDirected<T>
               ...
               IWeight
{
    ...
    public AdjacentMatrixWeightDirected(  )
                                 throws Exception
    {
        this( AdjacentMatrixWeightDirected.DEFAULT_QTY );
    }

    public AdjacentMatrixWeightDirected( int vertexQty )
                                 throws Exception
    {
        if ( vertexQty <= 0 )
        {
                         ...
                         throws Exception
    {
        ...
        {
            vertexObjectList.set( vertex, (T) AdjacentMatrixWeightDirected.OBJECT );
        } else
        {
                   ...
                   throws Exception
    {
        if ( isInvalidVertex( startVertex ) || isInvalidVertex( endVertex ) )
        {
            throw new Exception( "Bad parameter used un start vertex or endVertex or weight" );
        }

        boolean containsWeight = subContainsWeight( startVertex, endVertex, weight );
    ...
    public void deleteWeight( int startVertex, int endVertex, int weight )
                      throws Exception
    {
        if ( isInvalidVertex( startVertex ) || isInvalidVertex( endVertex ) || ( weight <= 0 ) )
        {
            throw new Exception( "Bad parameter used un start vertex or endVertex or weight" );
        }
                            ...
                            throws Exception
    {
        ...
        if ( isInvalidVertex( startVertex ) || isInvalidVertex( endVertex ) )
        {
            throw new Exception( "Bad parameter used un start vertex or endVertex " );
        }
