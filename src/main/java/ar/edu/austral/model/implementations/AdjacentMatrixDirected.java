...
public class AdjacentMatrixDirected<T> implements Directed<T> {
	...
	public AdjacentMatrixDirected() throws Exception {

		this(AdjacentMatrixDirected.DEFAULT_QTY);
	}

	public AdjacentMatrixDirected(int vertexQty) throws Exception {
		if (vertexQty <= 0) {
