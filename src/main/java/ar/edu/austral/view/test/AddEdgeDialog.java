    ...
    extends javax.swing.JDialog
{
    ...
    protected void acceptButtonActionPerformed( ActionEvent evt )
    {
        ...
        {
            JOptionPane.showMessageDialog( jFrame, GraphAppConstants.MESSAGE_ERROR_ALREADY_EXISTS );
        }
    }
    ...
    private void initGUI(  )
    {
        try
        {
...

            {
                ...
                FormLayout jPanel1Layout =
                    new FormLayout( "26dlu, max(p;5dlu), max(p;5dlu), 25dlu, 42dlu, max(p;15dlu), max(p;15dlu)",
                ...
                jPanel1.add( origenTextField,
                             new CellConstraints( "4, 2, 1, 1, default, default" ) );
                origenTextField.setPreferredSize( new java.awt.Dimension( 22, 21 ) );
                ...
                jPanel1.add( destinoTextField,
                             new CellConstraints( "4, 4, 1, 1, default, default" ) );
                destinoTextField.setPreferredSize( new java.awt.Dimension( 21, 21 ) );
                ...
                jPanel1.add( costoTextField,
                             new CellConstraints( "4, 6, 1, 1, default, default" ) );
                costoTextField.setPreferredSize( new java.awt.Dimension( 24, 21 ) );
                acceptButton = new JButton(  );
                jPanel1.add( acceptButton,
                             new CellConstraints( "5, 8, 1, 1, default, default" ) );
                acceptButton.setText( "Aceptar" );
                cancelButton = new JButton(  );
                jPanel1.add( cancelButton,
                             new CellConstraints( "6, 8, 1, 1, default, default" ) );
